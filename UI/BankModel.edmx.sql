...
-- --------------------------------------------------
-- Date Created: 07/04/2017 18:07:55
-- Generated from EDMX file: C:\Users\Grzegorz\Desktop\Bank\UI\BankModel.edmx
-- --------------------------------------------------
...
-- Creating primary key on [id_rachunku], [numer], [dostepne_srodki] in table 'Rachunki_obce'
ALTER TABLE [dbo].[Rachunki_obce]
ADD CONSTRAINT [PK_Rachunki_obce]
    PRIMARY KEY CLUSTERED ([id_rachunku], [numer], [dostepne_srodki] ASC);
GO

-- Creating primary key on [numer] in table 'Banki_numery'
...
-- Creating foreign key on [status] in table 'Historia_wewnatrzbankowa'
ALTER TABLE [dbo].[Historia_wewnatrzbankowa]
ADD CONSTRAINT [FK_Historia_wewnatrzbankowa_Status]
    FOREIGN KEY ([status])
    REFERENCES [dbo].[Historia_status]
        ([id_status])
    ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- Creating non-clustered index for FOREIGN KEY 'FK_Historia_wewnatrzbankowa_Status'
CREATE INDEX [IX_FK_Historia_wewnatrzbankowa_Status]
...
ALTER TABLE [dbo].[Historia_wewnatrzbankowa]
ADD CONSTRAINT [FK_Historia_wewnatrzbankowa_Rachunki_1]
...
-- Creating non-clustered index for FOREIGN KEY 'FK_Historia_wewnatrzbankowa_Rachunki_1'
CREATE INDEX [IX_FK_Historia_wewnatrzbankowa_Rachunki_1]
ON [dbo].[Historia_wewnatrzbankowa]
    ([id_rachunku_nadawca]);
GO
...
ALTER TABLE [dbo].[Historia_wewnatrzbankowa]
ADD CONSTRAINT [FK_Historia_wewnatrzbankowa_Rachunki_2]
...
-- Creating non-clustered index for FOREIGN KEY 'FK_Historia_wewnatrzbankowa_Rachunki_2'
CREATE INDEX [IX_FK_Historia_wewnatrzbankowa_Rachunki_2]
ON [dbo].[Historia_wewnatrzbankowa]
